...
- Release 1.0.8:
  ...
  - Y90 decay now reproduces as well as possible the positron energy spectrum from the internal pair production
    using an approximated shape using a truncated polynomial of degree two
    (see Dryák P.  Jaroslav Š.,  *Measurement of the branching ratio related to the internal pair production of Y-90.*,
