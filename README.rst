...
.. code:: sh
   ...
   $ cd /tmp
   $ curl -L https://github.com/BxCppDev/bxdecay0/archive/1.2.0.tar.gz -o bxdecay0-1.2.0.tar.gz
   $ tar xvzf bxdecay0-1.2.0.tar.gz
   $ ls -l bxdecay0-1.2.0/
..
...
.. code:: sh
   ...
   $ cmake -DCMAKE_INSTALL_PREFIX=${HOME}/sw/bxdecay0 /tmp/bxdecay0-1.2.0
..
