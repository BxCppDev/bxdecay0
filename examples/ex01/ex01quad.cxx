...
int main()
{
  ...
  try {
    ...
    decay0.set_decay_dbd_esum_range(1.5, 1.73); // generate only high energy part of the spectrum (MeV)
    ...
    std::cout << "high energy event ratio : " << decay0.get_to_all_events() << '\n';
