...
namespace bxdecay0 {
                ...
                const int levelkev_)
  {
    ...
    // VIT, 23.12.2008.
    tclev=0.;
    if (levelkev_ == 1871) goto label_1871;
    if (levelkev_ == 1469) goto label_1469;
    if (levelkev_ == 1433) goto label_1433;
    if (levelkev_ == 1312) goto label_1312;
    if (levelkev_ == 1224) goto label_1224;
    if (levelkev_ ==  618) goto label_618;
    if (levelkev_ ==  0) goto label_10000;
    goto label_20000;
  label_1871  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 86.91) goto label_18711;
    if (p <= 89.88) goto label_18712;
    goto label_18713;
  label_18711  :
  ...
  label_1469  :
    thlev=2.7e-12;
    p=100.*prng_();
    if (p <= 36.98) goto label_14691;
    if (p <= 99.14) goto label_14692;
    goto label_14693;
  label_14691  :
  ...
  label_1433  :
    thlev=1.9e-9;
    p=100.*prng_();
    if (p <=  0.66) goto label_14331;
    if (p <= 39.36) goto label_14332;
    if (p <= 60.61) goto label_14333;
    goto label_14334;
  label_14331  :
    p=100.*prng_();
    if (p <= 3.8) {  ;// e0.exe
