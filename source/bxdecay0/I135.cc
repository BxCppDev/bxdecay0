...
namespace bxdecay0 {
            ...
            double & tdnuc_)
  {
    ...
    tclev=0.;
    pbeta=100.*prng_();
    if (pbeta <=  0.013) goto label_2478;
    if (pbeta <=  0.155) goto label_2475;
    if (pbeta <=  0.282) goto label_2466;
    if (pbeta <=  0.422) goto label_2447;
    if (pbeta <=  1.449) goto label_2409;
    if (pbeta <=  2.366) goto label_2372;
    if (pbeta <=  3.752) goto label_2357;
    if (pbeta <=  8.518) goto label_2255;
    if (pbeta <= 15.896) goto label_2233;
    if (pbeta <= 15.919) goto label_2152;
    if (pbeta <= 15.989) goto label_2112;
    if (pbeta <= 17.574) goto label_2093;
    if (pbeta <= 18.681) goto label_2046;
    if (pbeta <= 26.657) goto label_1968;
    if (pbeta <= 26.707) goto label_1927;
    if (pbeta <= 27.315) goto label_1894;
    if (pbeta <= 36.089) goto label_1791;
    if (pbeta <= 57.825) goto label_1678;
    if (pbeta <= 65.801) goto label_1565;
    if (pbeta <= 73.279) goto label_1458;
    if (pbeta <= 96.810) goto label_1260;
    if (pbeta <= 98.106) goto label_1132;
    goto label_527;
  label_2478  :
  ...
  label_2466  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 56.69) goto label_24661;
    if (p <= 81.89) goto label_24662;
    goto label_24663;
  label_24661  :
  ...
  label_2409  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 93.48) goto label_24091;
    if (p <= 96.40) goto label_24092;
    goto label_24093;
  label_24091  :
  ...
  label_2357  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 41.91) goto label_23571;
    if (p <= 45.02) goto label_23572;
    if (p <= 51.45) goto label_23573;
    if (p <= 55.42) goto label_23574;
    if (p <= 64.74) goto label_23575;
    if (p <= 86.41) goto label_23576;
    goto label_23577;
  label_23571  :
  ...
  label_2255  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 12.88) goto label_22551;
    if (p <= 89.34) goto label_22552;
    if (p <= 92.51) goto label_22553;
    if (p <= 93.48) goto label_22554;
    if (p <= 97.07) goto label_22555;
    if (p <= 99.79) goto label_22556;
    goto label_22557;
  label_22551  :
  ...
  label_2233  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 55.75) goto label_22331;
    if (p <= 77.64) goto label_22332;
    if (p <= 94.09) goto label_22333;
    if (p <= 98.39) goto label_22334;
    if (p <= 99.68) goto label_22335;
    goto label_22336;
  label_22331  :
  ...
  label_20930  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 72.79) goto label_20931;
    if (p <= 81.26) goto label_20932;
    if (p <= 98.25) goto label_20933;
    goto label_20934;
  label_20931  :
  ...
  label_2046  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 79.31) goto label_20461;
    if (p <= 93.16) goto label_20462;
    if (p <= 97.90) goto label_20463;
    goto label_20464;
  label_20461  :
  ...
  label_1968  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <=  0.21) goto label_19681;
    if (p <= 84.72) goto label_19682;
    if (p <= 93.05) goto label_19683;
    if (p <= 95.98) goto label_19684;
    goto label_19685;
  label_19681  :
  ...
  label_19270  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 58.50) goto label_19271;
    if (p <= 63.05) goto label_19272;
    goto label_19273;
  label_19271  :
  ...
  label_17910  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 86.68) goto label_17911;
    if (p <= 98.81) goto label_17912;
    if (p <= 99.17) goto label_17913;
    if (p <= 99.18) goto label_17914;
    if (p <= 99.60) goto label_17915;
    if (p <= 99.92) goto label_17916;
    goto label_17917;
  label_17911  :
  ...
  label_16780  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 42.57) goto label_16781;
    if (p <= 74.58) goto label_16782;
    if (p <= 90.20) goto label_16783;
    if (p <= 91.38) goto label_16784;
    if (p <= 99.94) goto label_16785;
    goto label_16786;
  label_16781  :
  ...
  label_15650  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 93.00) goto label_15651;
    if (p <= 99.62) goto label_15652;
    goto label_15653;
  label_15651  :
  ...
  label_14580  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 90.44) goto label_14581;
    if (p <= 99.59) goto label_14582;
    if (p <= 99.61) goto label_14583;
    goto label_14584;
  label_14581  :
