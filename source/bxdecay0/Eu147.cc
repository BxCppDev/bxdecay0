...
namespace bxdecay0 {
             ...
             double & tdnuc_)
  {
    ...
    if (pdecay <=  0.202) goto label_1646;
    if (pdecay <=  0.502) goto label_1549;
    if (pdecay <=  0.552) goto label_1471;
    if (pdecay <=  1.552) goto label_1453;
    if (pdecay <=  2.052) goto label_1318;
    if (pdecay <=  2.252) goto label_1304;
    if (pdecay <= 11.352) goto label_1077;
    if (pdecay <= 11.582) goto label_1063;
    if (pdecay <= 17.102) goto label_1054;
    if (pdecay <= 17.182) goto label_1007;
    if (pdecay <= 35.382) goto label_799;
    if (pdecay <= 57.592) goto label_197;
    if (pdecay <= 76.792) goto label_121;
    goto label_10000;
  label_1646  :
  ...
  label_1318  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 22.8) goto label_13181;
    if (p <= 68.3) goto label_13182;
    goto label_13183;
  label_13181  :
  ...
  label_1077  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 62.5) goto label_10771;
    if (p <= 98.5) goto label_10772;
    goto label_10773;
  label_10771  :
  ...
  label_79900  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 24.2) goto label_79901;
    if (p <= 71.7) goto label_79902;
    goto label_79903;
  label_79901  :
  ...
  label_197  :
    p=100.*prng_();
    if (p <= 99.4) decay0_gamma(prng_, event_, 0.049,0.,0.,t);
    if (p > 99.4) decay0_beta(prng_, event_, 0.511,-62.,0.,0.,t);
  label_19700  :
    thlev=1.3e-9;
    p=100.*prng_();
    if (p <= 97.2) goto label_19701;
    goto label_19702;
  label_19701  :
  ...
  label_121  :
    p=100.*prng_();
    if (p <= 99.5) decay0_gamma(prng_, event_, 0.049,0.,0.,t);
    if (p > 99.5) decay0_beta(prng_, event_, 0.587,-62.,0.,0.,t);
  label_12100  :
    thlev=0.77e-9;
  ...
  label_10000  :
    p=100.*prng_();
    if (p <= 99.3) decay0_gamma(prng_, event_, 0.049,0.,0.,t);
    if (p > 99.3) decay0_beta(prng_, event_, 0.708,-62.,0.,0.,t);
    return;
  }
  // end of Eu147.f
