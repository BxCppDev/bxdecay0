...
namespace bxdecay0 {
               ...
               const int levelkev_)
  {
    ...
    tclev=0.;
    if (levelkev_ == 2713) goto label_2713;
    if (levelkev_ == 2700) goto label_2700;
    if (levelkev_ == 2623) goto label_2623;
    if (levelkev_ == 2426) goto label_2426;
    if (levelkev_ == 2096) goto label_2096;
    if (levelkev_ == 1626) goto label_1626;
    if (levelkev_ == 1498) goto label_1498;
    if (levelkev_ == 1148) goto label_1148;
    if (levelkev_ ==  778) goto label_778;
  ...
  label_2700  :
    thlev=0.103e-12;
    p=100.*prng_();
    if (p <=  3.04) goto label_27001;
    if (p <= 12.12) goto label_27002;
    if (p <= 53.40) goto label_27003;
    if (p <= 86.67) goto label_27004;
    goto label_27005;
  label_27001  :
  ...
  label_2540  :
    thlev=0.069e-12;
    p=100.*prng_();
    if (p <=  8.17) goto label_25401;
    if (p <= 28.31) goto label_25402;
    goto label_25403;
  label_25401  :
  ...
  label_2426  :
    thlev=0.19e-12;
    p=100.*prng_();
    if (p <=  2.50) goto label_24261;
    if (p <= 38.16) goto label_24262;
    if (p <= 42.07) goto label_24263;
    if (p <= 95.22) goto label_24264;
    goto label_24265;
  label_24261  :
  ...
  label_2096  :
    thlev=0.097e-12;
    p=100.*prng_();
    if (p <=  3.06) goto label_20961;
    if (p <= 98.55) goto label_20962;
    goto label_20963;
  label_20961  :
  ...
  label_1978  :
    thlev=2.29e-12;
    p=100.*prng_();
    if (p <=  0.18) goto label_19781;
    if (p <=  5.96) goto label_19782;
    if (p <=  9.27) goto label_19783;
    if (p <= 30.34) goto label_19784;
    goto label_19785;
  label_19781  :
  ...
  label_1870  :
    thlev=6.4e-12;
    p=100.*prng_();
    if (p <=  7.52) goto label_18701;
    if (p <= 12.22) goto label_18702;
    goto label_18703;
  label_18701  :
  ...
  label_1626  :
    thlev=1.4e-12;
    p=100.*prng_();
    if (p <=  8.47) goto label_16261;
    if (p <= 98.58) goto label_16262;
    goto label_16263;
  label_16261  :
