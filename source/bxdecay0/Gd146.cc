...
namespace bxdecay0 {
	     ...
	     double & tdnuc_)
  {
    ...
    tclev=0.;
    pdecay=100.*prng_();
    if (pdecay <=  0.3) goto label_806;
    if (pdecay <=  0.8) goto label_743;
    if (pdecay <= 77.2) goto label_385;
    goto label_230;
  label_806  :
  ...
  label_385  :
    p=100.*prng_();
    if (p <= 99.91) decay0_gamma(prng_, event_, 0.049,0.,0.,t);
    if (p > 99.91) decay0_beta(prng_, event_, 0.343,-63.,0.,0.,t);
  label_38500  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 0.4) goto label_38501;
    goto label_38502;
  label_38501  :
