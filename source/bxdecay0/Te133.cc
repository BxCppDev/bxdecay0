...
namespace bxdecay0 {
             ...
             double & tdnuc_)
  {
    ...
    tclev=0.;
    pbeta=100.*prng_();
    if (pbeta <=  0.13) goto label_2936;
    if (pbeta <=  0.60) goto label_2866;
    if (pbeta <=  0.86) goto label_2825;
    if (pbeta <=  1.29) goto label_2808;
    if (pbeta <=  2.34) goto label_2768;
    if (pbeta <=  2.52) goto label_2661;
    if (pbeta <=  2.70) goto label_2597;
    if (pbeta <=  4.86) goto label_2542;
    if (pbeta <=  5.24) goto label_2526;
    if (pbeta <=  5.60) goto label_2493;
    if (pbeta <=  6.20) goto label_2467;
    if (pbeta <=  6.75) goto label_2417;
    if (pbeta <=  6.86) goto label_2393;
    if (pbeta <=  7.00) goto label_2364;
    if (pbeta <=  7.26) goto label_2284;
    if (pbeta <=  7.72) goto label_2266;
    if (pbeta <=  8.96) goto label_2255;
    if (pbeta <=  9.95) goto label_2225;
    if (pbeta <= 11.27) goto label_2210;
    if (pbeta <= 13.53) goto label_2194;
    if (pbeta <= 15.90) goto label_2136;
    if (pbeta <= 16.97) goto label_2054;
    if (pbeta <= 17.31) goto label_2040;
    if (pbeta <= 18.70) goto label_2025;
    if (pbeta <= 28.99) goto label_1718;
    if (pbeta <= 30.31) goto label_1671;
    if (pbeta <= 33.78) goto label_1564;
    if (pbeta <= 34.97) goto label_1374;
    if (pbeta <= 47.93) goto label_1333;
    if (pbeta <= 51.20) goto label_1313;
    if (pbeta <= 51.40) goto label_1240;
    if (pbeta <= 79.41) goto label_720;
    goto label_312;
  label_2936  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 72.87) goto label_29361;
    if (p <= 92.25) goto label_29362;
    goto label_29363;
  label_29361  :
  ...
  label_2866  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 74.63) goto label_28661;
    if (p <= 94.67) goto label_28662;
    goto label_28663;
  label_28661  :
  ...
  label_2808  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 46.23) goto label_28081;
    if (p <= 63.26) goto label_28082;
    if (p <= 92.46) goto label_28083;
    goto label_28084;
  label_28081  :
  ...
  label_2768  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 24.57) goto label_27681;
    if (p <= 28.07) goto label_27682;
    if (p <= 42.25) goto label_27683;
    if (p <= 71.55) goto label_27684;
    if (p <= 82.89) goto label_27685;
    if (p <= 88.56) goto label_27686;
    if (p <= 91.49) goto label_27687;
    goto label_27688;
  label_27681  :
  ...
  label_2661  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 43.10) goto label_26611;
    if (p <= 47.70) goto label_26612;
    if (p <= 82.18) goto label_26613;
    goto label_26614;
  label_26611  :
  ...
  label_25970  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 20.00) goto label_25971;
    if (p <= 23.21) goto label_25972;
    if (p <= 73.21) goto label_25973;
    if (p <= 80.00) goto label_25974;
    if (p <= 88.93) goto label_25975;
    if (p <= 91.07) goto label_25976;
    goto label_25977;
  label_25971  :
  ...
  label_2542  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 23.06) goto label_25421;
    if (p <= 63.19) goto label_25422;
    if (p <= 73.34) goto label_25423;
    if (p <= 75.37) goto label_25424;
    if (p <= 77.40) goto label_25425;
    if (p <= 84.78) goto label_25426;
    if (p <= 90.32) goto label_25427;
    if (p <= 94.47) goto label_25428;
    goto label_25429;
  label_25421  :
  ...
  label_2526  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <=  3.97) goto label_25261;
    if (p <= 37.30) goto label_25262;
    if (p <= 78.57) goto label_25263;
    if (p <= 86.51) goto label_25264;
    if (p <= 90.48) goto label_25265;
    goto label_25266;
  label_25261  :
  ...
  label_2493  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <=  8.93) goto label_24931;
    if (p <= 48.72) goto label_24932;
    if (p <= 65.81) goto label_24933;
    goto label_24934;
  label_24931  :
  ...
  label_24670  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 61.38) goto label_24671;
    if (p <= 65.12) goto label_24672;
    if (p <= 78.59) goto label_24673;
    if (p <= 95.36) goto label_24674;
    goto label_24675;
  label_24671  :
  ...
  label_2417  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 34.48) goto label_24171;
    if (p <= 52.63) goto label_24172;
    if (p <= 63.52) goto label_24173;
    if (p <= 68.06) goto label_24174;
    if (p <= 73.69) goto label_24175;
    if (p <= 95.46) goto label_24176;
    goto label_24177;
  label_24171  :
  ...
  label_2393  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 11.32) goto label_23931;
    if (p <= 64.16) goto label_23932;
    if (p <= 82.08) goto label_23933;
    goto label_23934;
  label_23931  :
  ...
  label_2364  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 18.52) goto label_23641;
    if (p <= 62.96) goto label_23642;
    goto label_23643;
  label_23641  :
  ...
  label_22840  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  5.77) goto label_22841;
    if (p <= 34.62) goto label_22842;
    if (p <= 53.85) goto label_22843;
    goto label_22844;
  label_22841  :
  ...
  label_2266  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 52.17) goto label_22661;
    if (p <= 64.34) goto label_22662;
    if (p <= 90.43) goto label_22663;
    goto label_22664;
  label_22661  :
  ...
  label_2255  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 16.92) goto label_22551;
    if (p <= 23.45) goto label_22552;
    if (p <= 40.37) goto label_22553;
    if (p <= 44.40) goto label_22554;
    if (p <= 54.07) goto label_22555;
    if (p <= 79.05) goto label_22556;
    if (p <= 88.72) goto label_22557;
    goto label_22558;
  label_22551  :
  ...
  label_22250  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 19.00) goto label_22251;
    if (p <= 29.28) goto label_22252;
    if (p <= 35.32) goto label_22253;
    if (p <= 35.84) goto label_22254;
    if (p <= 47.67) goto label_22255;
    if (p <= 53.02) goto label_22256;
    if (p <= 79.79) goto label_22257;
    if (p <= 84.97) goto label_22258;
    if (p <= 96.80) goto label_22259;
    goto label_22260;
  label_22251  :
  ...
  label_22100  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 46.12) goto label_22101;
    if (p <= 53.21) goto label_22102;
    if (p <= 61.23) goto label_22103;
    if (p <= 73.93) goto label_22104;
    goto label_22105;
  label_22101  :
  ...
  label_2194  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 25.07) goto label_21941;
    if (p <= 78.72) goto label_21942;
    if (p <= 92.79) goto label_21943;
    if (p <= 94.72) goto label_21944;
    if (p <= 97.36) goto label_21945;
    goto label_21946;
  label_21941  :
  ...
  label_2136  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 57.73) goto label_21361;
    if (p <= 69.61) goto label_21362;
    if (p <= 75.10) goto label_21363;
    if (p <= 79.32) goto label_21364;
    if (p <= 80.12) goto label_21365;
    if (p <= 82.23) goto label_21366;
    if (p <= 86.03) goto label_21367;
    if (p <= 89.41) goto label_21368;
    if (p <= 94.94) goto label_21369;
    goto label_21370;
  label_21361  :
  ...
  label_20540  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 12.21) goto label_20541;
    if (p <= 24.15) goto label_20542;
    if (p <= 31.12) goto label_20543;
    if (p <= 47.69) goto label_20544;
    if (p <= 58.15) goto label_20545;
    if (p <= 67.74) goto label_20546;
    if (p <= 84.31) goto label_20547;
    if (p <= 94.77) goto label_20548;
    goto label_20549;
  label_20541  :
  ...
  label_20400  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  6.87) goto label_20401;
    if (p <= 12.09) goto label_20402;
    if (p <= 23.08) goto label_20403;
    if (p <= 75.28) goto label_20404;
    goto label_20405;
  label_20401  :
  ...
  label_20250  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  4.60) goto label_20251;
    if (p <= 25.61) goto label_20252;
    if (p <= 40.94) goto label_20253;
    if (p <= 47.75) goto label_20254;
    if (p <= 54.00) goto label_20255;
    if (p <= 64.79) goto label_20256;
    goto label_20257;
  label_20251  :
  ...
  label_17180  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 30.02) goto label_17181;
    if (p <= 35.59) goto label_17182;
    if (p <= 45.41) goto label_17183;
    if (p <= 81.39) goto label_17184;
    if (p <= 81.97) goto label_17185;
    if (p <= 85.56) goto label_17186;
    if (p <= 94.43) goto label_17187;
    if (p <= 96.88) goto label_17188;
    if (p <= 99.43) goto label_17189;
    goto label_17190;
  label_17181  :
  ...
  label_16710  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  9.59) goto label_16711;
    if (p <= 15.22) goto label_16712;
    if (p <= 28.40) goto label_16713;
    if (p <= 71.54) goto label_16714;
    if (p <= 78.73) goto label_16715;
    if (p <= 83.94) goto label_16716;
    goto label_16717;
  label_16711  :
  ...
  label_15640  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 28.18) goto label_15641;
    if (p <= 92.95) goto label_15642;
    if (p <= 96.86) goto label_15643;
    if (p <= 97.85) goto label_15644;
    if (p <= 98.46) goto label_15645;
    if (p <= 98.83) goto label_15646;
    goto label_15647;
  label_15641  :
  ...
  label_13740  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 56.13) goto label_13741;
    if (p <= 14.62) goto label_13742;
    goto label_13743;
  label_13741  :
  ...
  label_13330  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 74.49) goto label_13331;
    if (p <= 94.05) goto label_13332;
    if (p <= 96.28) goto label_13333;
    if (p <= 99.83) goto label_13334;
    goto label_13335;
  label_13331  :
  ...
  label_13130  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 17.45) goto label_13131;
    if (p <= 91.78) goto label_13132;
    if (p <= 95.27) goto label_13133;
    goto label_13134;
  label_13131  :
  ...
  label_13070  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 33.13) goto label_13071;
    if (p <= 75.46) goto label_13072;
    if (p <= 81.59) goto label_13073;
    if (p <= 82.76) goto label_13074;
    if (p <= 84.66) goto label_13075;
    goto label_13076;
  label_13071  :
  ...
  label_12400  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 24.03) goto label_12401;
    if (p <= 81.24) goto label_12402;
    if (p <= 86.27) goto label_12403;
    goto label_12404;
  label_12401  :
  ...
  label_78700  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 78.49) goto label_78701;
    if (p <= 91.28) goto label_78702;
    goto label_78703;
  label_78701  :
