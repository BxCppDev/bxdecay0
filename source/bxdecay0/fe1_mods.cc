...
namespace bxdecay0 {
  ...
  double decay0_fe1_mod1(double e1_, void * params_)
  {
    ...
    if (e1_ > e0) return 0.0;
    double e2 = e0 - e1_;
    double p1 = std::sqrt(e1_*(e1_+2.*emass));
    double p2 = std::sqrt(e2*(e2+2.*emass));
    return (e1_+emass)*p1*bxdecay0::decay0_fermi(Zdbb,e1_)*
      (e2+emass)*p2*bxdecay0::decay0_fermi(Zdbb,e2);
  }
  ...
  double decay0_fe1_mod3(double e1_, void * params_)
  {
    ...
    return p1*bxdecay0::decay0_fermi(Zdbb,e1_)*p2*bxdecay0::decay0_fermi(Zdbb,e2)*
      (2. * gsl_pow_2(p1*p2) + 9. * ((e1_+emass)*(e2+emass)+gsl_pow_2(emass))*
  ...
  double decay0_fe1_mod18(double e1_, void * params_)
  {
    ...
    double a_eta=a1*gsl_pow_2(chi_2plus)
      ...
      +a6*gsl_pow_2(chip_P);
    return (e1_+emass)*p1*bxdecay0::decay0_fermi(Zdbb,e1_)*
      (e2+emass)*p2*bxdecay0::decay0_fermi(Zdbb,e2)*a_eta;
  }
