...
namespace bxdecay0 {
             ...
             double & tdnuc_)
  {
    ...
    tclev=0.;
    pdecay=100.*prng_();
    if (pdecay <= 72.08) goto label_1;  // EC to 152Sm
    goto label_2;  // b- to 152Gd
    // approximate electron capture from K (82%), L (14%) or M (4%) shell
  label_1  :
    pKLM=100.*prng_();
    if (pKLM <= 82.) decay0_gamma(prng_, event_, 0.047,0.,0.,tdlev);
    if (pKLM > 82.  &&  pKLM <= 96.) decay0_gamma(prng_, event_, 0.008,0.,0.,tdlev);
    if (pKLM > 96.) decay0_gamma(prng_, event_, 0.001,0.,0.,tdlev);
    pec=100.*prng_();
    if (pec <=  0.071) goto label_1769;
    if (pec <=  0.118) goto label_1757;
    if (pec <=  0.180) goto label_1730;
    if (pec <=  1.416) goto label_1650;
    if (pec <=  1.445) goto label_1613;
    if (pec <=  4.292) goto label_1579;
    if (pec <= 38.592) goto label_1530;
    if (pec <= 39.883) goto label_1372;
    if (pec <= 40.744) goto label_1293;
    if (pec <= 64.629) goto label_1234;
    if (pec <= 94.069) goto label_1086;
    if (pec <= 94.152) goto label_1041;
    if (pec <= 94.471) goto label_1023;
    if (pec <= 96.179) goto label_810;
    if (pec <= 97.359) goto label_366;
    goto label_122;
  label_1769  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 15.21) goto label_17691;
    if (p <= 25.62) goto label_17692;
    if (p <= 65.65) goto label_17693;
    if (p <= 88.07) goto label_17694;
    if (p <= 99.28) goto label_17695;
    goto label_17696;
  label_17691  :
  ...
  label_1757  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  0.43) goto label_17571;
    if (p <= 14.38) goto label_17572;
    if (p <= 81.12) goto label_17573;
    if (p <= 85.46) goto label_17574;
    goto label_17575;
  label_17571  :
  ...
  label_1730  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 11.26) goto label_17301;
    if (p <= 66.17) goto label_17302;
    if (p <= 79.35) goto label_17303;
    goto label_17304;
  label_17301  :
  ...
  label_1650  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 30.00) goto label_16501;
    if (p <= 31.85) goto label_16502;
    if (p <= 34.02) goto label_16503;
    if (p <= 86.93) goto label_16504;
    if (p <= 99.47) goto label_16505;
    goto label_16506;
  label_16501  :
  ...
  label_1613  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 71.28) goto label_16131;
    if (p <= 94.09) goto label_16132;
    goto label_16133;
  label_16131  :
  ...
  label_1579  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 24.04) goto label_15791;
    if (p <= 92.32) goto label_15792;
    if (p <= 96.69) goto label_15793;
    if (p <= 97.13) goto label_15794;
    if (p <= 98.06) goto label_15795;
    if (p <= 98.26) goto label_15796;
    if (p <= 99.79) goto label_15797;
    goto label_15798;
  label_15791  :
  ...
  label_1530  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 84.56) goto label_15301;
    if (p <= 84.80) goto label_15302;
    if (p <= 85.32) goto label_15303;
    if (p <= 86.97) goto label_15304;
    if (p <= 98.22) goto label_15305;
    goto label_15306;
  label_15301  :
  ...
  label_1372  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 19.62) goto label_13721;
    if (p <= 88.70) goto label_13722;
    if (p <= 90.70) goto label_13723;
    if (p <= 90.81) goto label_13724;
    if (p <= 98.82) goto label_13725;
    goto label_13726;
  label_13721  :
  ...
  label_1293  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 16.39) goto label_12931;
    if (p <= 22.12) goto label_12932;
    if (p <= 64.58) goto label_12933;
    if (p <= 68.91) goto label_12934;
    if (p <= 88.66) goto label_12935;
    if (p <= 89.98) goto label_12936;
    goto label_12937;
  label_12931  :
  ...
  label_1234  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 76.33) goto label_12341;
    if (p <= 99.76) goto label_12342;
    if (p <= 99.78) goto label_12343;
    goto label_12344;
  label_12341  :
  ...
  label_1086  :
    thlev=0.85e-12;
    p=100.*prng_();
    if (p <= 40.36) goto label_10861;
    if (p <= 98.77) goto label_10862;
    if (p <= 99.86) goto label_10863;
    goto label_10864;
  label_10861  :
  ...
  label_1023  :
    thlev=6.7e-12;
    p=100.*prng_();
    if (p <= 35.73) goto label_10231;
    if (p <= 91.56) goto label_10232;
    if (p <= 92.40) goto label_10233;
    goto label_10234;
  label_10231  :
  ...
  label_963  :
    thlev=28.2e-15;
    p=100.*prng_();
    if (p <= 45.143) goto label_96301;
    if (p <= 99.994) goto label_96302;
    if (p <= 99.995) goto label_96303;
    goto label_96304;
  label_96301  :
  ...
  label_810  :
    thlev=7.2e-12;
    p=100.*prng_();
    if (p <= 21.66) goto label_81001;
    if (p <= 78.06) goto label_81002;
    if (p <= 99.21) goto label_81003;
    goto label_81004;
  label_81001  :
  ...
  label_2  :
    pbeta=100.*prng_();
    if (pbeta <=  0.071) goto label_1692;
    if (pbeta <=  6.421) goto label_1643;
    if (pbeta <=  6.778) goto label_1606;
    if (pbeta <= 15.339) goto label_1434;
    if (pbeta <= 15.981) goto label_1318;
    if (pbeta <= 16.063) goto label_1282;
    if (pbeta <= 65.291) goto label_1123;
    if (pbeta <= 66.325) goto label_1109;
    if (pbeta <= 67.395) goto label_931;
    if (pbeta <= 70.748) goto label_755;
    goto label_344;
  label_1692  :
  ...
  label_1643  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 89.21) goto label_16431;
    if (p <= 94.47) goto label_16432;
    if (p <= 96.83) goto label_16433;
    if (p <= 99.75) goto label_16434;
    if (p <= 99.76) goto label_16435;
    goto label_16436;
  label_16431  :
  ...
  label_1606  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <=  7.64) goto label_16061;
    if (p <= 40.86) goto label_16062;
    if (p <= 72.09) goto label_16063;
    if (p <= 91.36) goto label_16064;
    if (p <= 95.35) goto label_16065;
    if (p <= 99.99) goto label_16066;
    goto label_16067;
  label_16061  :
  ...
  label_14340  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 71.07) goto label_14341;
    if (p <= 90.54) goto label_14342;
    if (p <= 96.87) goto label_14343;
    if (p <= 99.99) goto label_14344;
    goto label_14345;
  label_14341  :
  ...
  label_13180  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  6.87) goto label_13181;
    if (p <= 62.27) goto label_13182;
    if (p <= 76.12) goto label_13183;
    if (p <= 77.39) goto label_13184;
    if (p <= 84.76) goto label_13185;
    if (p <= 92.35) goto label_13186;
    if (p <= 92.79) goto label_13187;
    goto label_13188;
  label_13181  :
  ...
  label_1282  :
    ...
    thlev=0.;
    p=100.*prng_();
    if (p <= 58.41) goto label_12821;
    if (p <= 98.13) goto label_12822;
    goto label_12823;
  label_12821  :
  ...
  label_11230  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 93.11) goto label_11231;
    if (p <= 99.26) goto label_11232;
    goto label_11233;
  label_11231  :
  ...
  label_11090  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 50.00) goto label_11091;
    if (p <= 97.50) goto label_11092;
    goto label_11093;
  label_11091  :
  ...
  label_10480  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  0.88) goto label_10481;
    if (p <= 65.79) goto label_10482;
    if (p <= 83.77) goto label_10483;
    goto label_10484;
  label_10481  :
  ...
  label_93100  :
    thlev=7.3e-12;
    p=100.*prng_();
    if (p <= 12.40) goto label_93101;
    if (p <= 90.91) goto label_93102;
    if (p <= 99.55) goto label_93103;
    goto label_93104;
  label_93101  :
