...
namespace bxdecay0 {
            ...
            double & tdnuc_)
  {
    ...
    tclev=0.;
    pbeta=100.*prng_();
    if (pbeta <=  0.368) goto label_3492;
    if (pbeta <=  0.435) goto label_3477;
    if (pbeta <=  2.216) goto label_3375;
    if (pbeta <=  3.300) goto label_3360;
    if (pbeta <=  3.509) goto label_3314;
    if (pbeta <=  3.567) goto label_3300;
    if (pbeta <=  3.786) goto label_3256;
    if (pbeta <=  5.129) goto label_3084;
    if (pbeta <= 35.372) goto label_2867;
    if (pbeta <= 35.889) goto label_2773;
    if (pbeta <= 42.754) goto label_2654;
    if (pbeta <= 58.871) goto label_2588;
    if (pbeta <= 62.950) goto label_2548;
    if (pbeta <= 69.516) goto label_2408;
    if (pbeta <= 80.460) goto label_2353;
    if (pbeta <= 82.689) goto label_2302;
    if (pbeta <= 84.281) goto label_2272;
    if (pbeta <= 87.564) goto label_1920;
    goto label_1731;
  label_3492  :
  ...
  label_3375  :
    ...
    if (p <= 33.52) goto label_33752;
    if (p <= 78.21) goto label_33753;
    goto label_33754;
  label_33751  :
  ...
  label_3084  :
    ...
    if (p <= 59.80) goto label_30842;
    if (p <= 90.32) goto label_30843;
    goto label_30844;
  label_30841  :
  ...
  label_2867  :
    ...
    if (p <= 30.54) goto label_28672;
    if (p <= 43.73) goto label_28673;
    if (p <= 49.75) goto label_28674;
    if (p <= 86.25) goto label_28675;
    if (p <= 93.65) goto label_28676;
    if (p <= 97.99) goto label_28677;
    if (p <= 99.50) goto label_28678;
    goto label_28679;
  label_28671  :
  ...
  label_26540  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 71.82) goto label_26541;
    if (p <= 98.18) goto label_26542;
    goto label_26543;
  label_26541  :
  ...
  label_25880  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 15.66) goto label_25881;
    if (p <= 44.90) goto label_25882;
    if (p <= 85.87) goto label_25883;
    goto label_25884;
  label_25881  :
  ...
  label_25480  :
    thlev=0.;
    p=100.*prng_();
    if (p <= 13.78) goto label_25481;
    if (p <= 63.11) goto label_25482;
    if (p <= 75.78) goto label_25483;
    goto label_25484;
  label_25481  :
  ...
  label_23530  :
    thlev=0.;
    p=100.*prng_();
    if (p <=  4.42) goto label_23531;
    if (p <= 73.01) goto label_23532;
    goto label_23533;
  label_23531  :
