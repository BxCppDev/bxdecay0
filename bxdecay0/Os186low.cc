...
namespace bxdecay0 {
  ...
  void Os186low(i_random & prng_, event & event_, const int levelkev_)
  {
    // double t;
    double tdlev;
    double tclev;
  ...
  label_137:
    ...
    decay0_nucltransKLM(prng_, event_, 0.137, 0.074, 0.44, 0.012, 0.64, 0.003, 0.20, 0., tclev, thlev, tdlev);
    return;
  label_10000:
    return;
  label_20000:
