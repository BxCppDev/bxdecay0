...
namespace bxdecay0 {
  ...
  struct enrange
  {
    double ebb1; ///< Left E sum limit for modes with continuous distribution of sum of e-/e+ energies (4,5,6,8,10 and
                 ///< 13), in which events will be generated (MeV)
    double ebb2; ///< Right E sum limit for modes with continuous distribution of sum of e-/e+ energies (4,5,6,8,10 and
                 ///< 13), in which events will be generated (MeV)
  ...
  /// \brief Subroutine for sampling the energies and angles of electrons in various modes of double beta decay without
