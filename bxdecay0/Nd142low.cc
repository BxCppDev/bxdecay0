...
namespace bxdecay0 {
  ...
  void Nd142low(i_random & /* prng_ */, event & /* event_ */, const int levelkev_)
  {
    // double t;
    // double tdlev;
    ////      double tclev;
    ...
    // Call : call Nd142low(levelkev_)
    // Input : levelkev_ - energy of Nd142 level (integer in keV) occupied
    // initially
    // 0+(gs) - 0 keV.
  ...
  label_10000:
    return;
  label_20000:
    // print *,'Nd142: wrong level [keV] ',levelkev_
    return;
  }
  // end of Nd142low.f
