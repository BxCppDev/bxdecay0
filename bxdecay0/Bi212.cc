...
namespace bxdecay0 {
  ...
  void Bi212(i_random & prng_, event & event_, const double tcnuc_, double & tdnuc_)
  {
    ...
    pdecay = prng_();
    if (pdecay <= 0.36) {
      goto label_10000; // 36% alfa to 208Tl
    }
  ...
  label_20000:
    pbeta = 64. * prng_();
    if (pbeta <= 0.660) {
      goto label_1806; // 0.660%
    }
    if (pbeta <= 0.687) {
      goto label_1801; // 0.027%
    }
    if (pbeta <= 0.937) {
      goto label_1680; // 0.250%
    }
    if (pbeta <= 2.837) {
      goto label_1621; // 1.900%
    }
    if (pbeta <= 4.337) {
      goto label_1513; // 1.500%
    }
    if (pbeta <= 8.737) {
      goto label_727; // 4.400%
    }
