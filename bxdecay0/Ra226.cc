...
namespace bxdecay0 {
  ...
  level_635000:
    ...
    if (debug) {
      std::cerr << "bxdecay0::Ra226: "
                << "level 635.5" << std::endl;
    }
    thlev = 0.;
    decay0_nucltransKLM(prng_,
                        event_,
                        0.44937,
                        RnElectronBindingEnergyK,
                        0.01123,
                        RnElectronBindingEnergyL,
                        0.00191,
                        RnElectronBindingEnergyM,
                        0.000449,
                        0.,
                        tclev,
                        thlev,
