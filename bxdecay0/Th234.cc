...
namespace bxdecay0 {
  ...
  void Th234(i_random & prng_, event & event_, const double tcnuc_, double & tdnuc_)
  {
    double t;
    double tdlev;
    double p;
    ...
    pbeta  = 100. * prng_();
    if (pbeta <= 1.501)
      goto label_187; // 1.501%
    if (pbeta <= 1.516)
      goto label_177; // 0.015%
    if (pbeta <= 7.921)
      goto label_167; // 6.405%
    if (pbeta <= 21.933)
      goto label_166; // 14.012%
  ...
  label_187:
    ...
    p     = 100. * prng_();
    if (p <= 17.0)
      goto label_18701; // 17.0%
    if (p <= 21.7)
      goto label_18702; // 4.7%
