...
namespace bxdecay0 {
  ...
  void Pb211(i_random & prng_, event & event_, const double tcnuc_, double & tdnuc_)
  {
    double t;
    double tdlev;
    double p;
    ...
    pbeta  = 100. * prng_();
    if (pbeta <= 0.0186)
      goto label_1271; // 0.0186%
    if (pbeta <= 0.0199)
      goto label_1234; // 0.0013%
    if (pbeta <= 0.0369)
      goto label_1196; // 0.0170%
    if (pbeta <= 0.8660)
      goto label_1109; // 0.8291%
    if (pbeta <= 0.8706)
      goto label_1104; // 0.0046%
    if (pbeta <= 0.9265)
      goto label_1081; // 0.0559%
    if (pbeta <= 0.9485)
      goto label_951; // 0.0220%
    if (pbeta <= 7.2616)
      goto label_832; // 6.3131%
    if (pbeta <= 8.7999)
      goto label_405; // 1.5383%
  ...
  label_1271:
    ...
    p     = 100. * prng_();
    if (p <= 36.76)
      goto label_12711; // 36.76%
    if (p <= 68.65)
      goto label_12712; // 31.89%
  ...
  label_1109:
    ...
    p     = 100. * prng_();
    if (p <= 13.9)
      goto label_11091; // 13.9%
    if (p <= 72.8)
      goto label_11092; // 58.9%
    if (p <= 77.0)
      goto label_11093; // 4.2%
  ...
  label_1081:
    ...
    p     = 100. * prng_();
    if (p <= 21.8)
      goto label_10811; // 21.8%
    if (p <= 44.9)
      goto label_10812; // 23.1%
  ...
  label_832:
    ...
    p     = 100. * prng_();
    if (p <= 57.4)
      goto label_83201; // 57.4%
    if (p <= 90.3)
      goto label_83202; // 32.9%
