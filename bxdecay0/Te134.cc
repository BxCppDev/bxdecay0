...
namespace bxdecay0 {
  ...
  void Te134(i_random & prng_, event & event_, const double tcnuc_, double & tdnuc_)
  {
    double t;
    double tdlev;
    double p;
  ...
  label_1106:
    ...
    p     = 100. * prng_();
    if (p <= 3.33)
      goto label_11061; // 3.33%
    if (p <= 14.45)
      goto label_11062; // 11.12%
    if (p <= 17.78)
      goto label_11063; // 3.33%
    if (p <= 91.15)
      goto label_11064; // 73.37%
    if (p <= 94.70)
      goto label_11065; // 3.55%
  ...
  label_92300:
    ...
    p     = 100. * prng_();
    if (p <= 2.71)
      goto label_92301; // 2.71%
    if (p <= 37.31)
      goto label_92302; // 34.60%
    if (p <= 47.94)
      goto label_92303; // 10.63%
    if (p <= 98.37)
      goto label_92304; // 50.43%
  ...
  label_84700:
    ...
    p     = 100. * prng_();
    if (p <= 69.71)
      goto label_84701; // 69.71%
    if (p <= 72.49)
      goto label_84702; // 2.78%
    if (p <= 76.45)
      goto label_84703; // 3.96%
  ...
  label_64500:
    ...
    p     = 100. * prng_();
    if (p <= 2.03)
      goto label_64501; // 2.03%
    if (p <= 45.01)
      goto label_64502; // 42.98%
    if (p <= 55.87)
      goto label_64503; // 10.86%
  ...
  label_18100:
    ...
    p     = 100. * prng_();
    if (p <= 95.83)
      goto label_18101; // 95.83%
    if (p <= 96.45)
      goto label_18102; // 0.62%
