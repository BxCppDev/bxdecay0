...
namespace bxdecay0 {
  ...
  void Sn114low(i_random & /* prng_ */, event & /* event_ */, const int levelkev_)
  {
    // double t;
    // double tdlev;
    ////double tclev;
    ...
    // Call : call Sn114low(levelkev_)
    // Input : levelkev_ - energy of Sn114 level (integer in keV) occupied
    // initially
    // 0+(gs) - 0 keV.
  ...
  label_10000:
    return;
  label_20000:
    // print *,'Sn114: wrong level [keV] ',levelkev_
    return;
  }
  // end of Sn114low.f
