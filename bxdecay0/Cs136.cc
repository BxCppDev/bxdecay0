...
namespace bxdecay0 {
  ...
  void Cs136(i_random & prng_, event & event_, const double tcnuc_, double & tdnuc_)
  {
    ...
    pbeta  = 100. * prng_();
    if (pbeta <= 2.025) {
      goto label_2374; // 2.025%
    }
    if (pbeta <= 2.233) {
      goto label_2357; // 0.208%
    }
    if (pbeta <= 72.009) {
      goto label_2207; // 69.776%
    }
    if (pbeta <= 82.431) {
      goto label_2140; // 10.422%
    }
    if (pbeta <= 87.097) {
      goto label_2054; // 4.666%
    }
  ...
  label_2374:
    ...
    p     = 100. * prng_();
    if (p <= 48.02) {
      goto label_23741; // 48.02%
    }
    if (p <= 73.36) {
      goto label_23742; // 25.34%
    }
    if (p <= 77.36) {
      goto label_23743; // 4.00%
    }
  ...
  label_2357:
    ...
    p     = 100. * prng_();
    if (p <= 47.12) {
      goto label_23571; // 47.12%
    }
    if (p <= 85.24) {
      goto label_23572; // 38.12%
    }
  ...
  label_22070:
    ...
    p     = 100. * prng_();
    if (p <= 61.84) {
      goto label_22071; // 61.84%
    }
    if (p <= 76.78) {
      goto label_22072; // 14.94%
    }
    if (p <= 88.48) {
      goto label_22073; // 11.70%
    }
  ...
  label_21400:
    ...
    p     = 100. * prng_();
    if (p <= 0.27) {
      goto label_21401; // 0.27%
    }
    if (p <= 60.13) {
      goto label_21402; // 59.86%
    }
    if (p <= 62.88) {
      goto label_21403; // 2.75%
    }
