...
namespace bxdecay0 {
  ...
  label_25062:
    ...
    goto label_13330;
  label_25063:
    decay0_nucltransK(prng_, event_, 0.347, 0.008, 5.5e-3, 0., tclev, thlev, tdlev);
    goto label_2159;
  label_2159:
    thlev = 0.;
    p     = 100. * prng_();
  ...
  label_21591:
    ...
    return;
  label_21592:
    decay0_nucltransK(prng_, event_, 0.826, 0.008, 3.3e-4, 0., tclev, thlev, tdlev);
    goto label_13330;
  ...
  label_1333:
    decay0_beta2(prng_, event_, 1.491, 28., 0., 0., t, 2, 3.333333, 1., 0., 0.);
  label_13330:
    thlev = 0.9e-12;
    ...
    label_1:
      ...
      if (pcor * (1. + std::abs(a2) + std::abs(a4)) > 1. + a2 * gsl_pow_2(ctet) + a4 * gsl_pow_4(ctet)) {
        goto label_1;
      }
      ipg1333->set_momentum(p1333 * stet1 * cos(phi1), p1333 * stet1 * sin(phi1), p1333 * ctet1);
      ipg1173->set_momentum(p1173 * stet2 * cos(phi2), p1173 * stet2 * sin(phi2), p1173 * ctet2);
    }
    return;
  }
