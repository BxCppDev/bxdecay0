...
namespace bxdecay0 {
  ...
  void Ru100low(i_random & prng_, event & event_, const int levelkev_)
  {
  ...
  label_17411:
    ...
    return;
  label_17412:
    decay0_nucltransK(prng_, event_, 1.201, 0.022, 6.2e-4, 0.1e-4, tclev, thlev, tdlev);
    goto label_540;
  label_17413:
    ...
    goto label_1130;
  label_17414:
    decay0_nucltransK(prng_, event_, 0.379, 0.022, 1.3e-2, 0., tclev, thlev, tdlev);
    goto label_1362;
  label_1362:
    thlev = 1.2e-12;
    p     = 100. * prng_();
  ...
  label_13621:
    ...
    return;
  label_13622:
    decay0_nucltransK(prng_, event_, 0.822, 0.022, 1.7e-3, 0., tclev, thlev, tdlev);
    goto label_540;
  label_1130:
    thlev = 0.;
    p     = 100. * prng_();
  ...
  label_540:
    ...
    label_1:
      ...
      ipg591->set_momentum(p591 * stet1 * cos(phi1), p591 * stet1 * sin(phi1), p591 * ctet1);
      ipg540->set_momentum(p540 * stet2 * cos(phi2), p540 * stet2 * sin(phi2), p540 * ctet2);
    }
    return;
  label_10000:
    return;
  label_20000 : {
    ...
    message << "genbb::decay0::Ru100low: Wrong energy level El=" << levelkev_ << " [keV] !";
